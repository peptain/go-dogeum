...
import (
	...
	"github.com/dogeum-network-network/go-dogeum/internal/jsre"
	"github.com/dogeum-network-network/go-dogeum/internal/jsre/deps"
	"github.com/dogeum-network-network/go-dogeum/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Dogeum requests through
...
// Welcome show summary of current GDoge instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the GDoge JavaScript console!\n\n"

	// Print some generic GDoge metadata

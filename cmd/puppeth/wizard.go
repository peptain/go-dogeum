...
type wizard struct {
	...
	services map[string][]string   // Dogeum services known to be running on servers
...
// converts it to an Dogeum address. If an empty line is entered, the default
// value is returned.

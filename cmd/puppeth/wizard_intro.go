...
// setting up a new or managing an existing Dogeum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Dogeum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Dogeum network down to  |")
	...
	log.Info("Administering Dogeum network", "name", w.network)

...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Dogeum presale wallets",
		ArgsUsage: "",
		Description: `
    gdoge wallet import /path/to/my/presale.wallet

will prompt for your password and imports your doge presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Dogeum presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gdoge wallet [options] /path/to/my/presale.wallet
...
between dogeum nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gdoge account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gdoge account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another dogeum instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gdogeConfig{Node: defaultNodeConfig()}
	// Load config file.

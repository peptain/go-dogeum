// Copyright 2021 The go-dogeum Authors
...
import (
	...
	"github.com/dogeum-network-network/go-dogeum/core/state/snapshot"
	...
	"github.com/dogeum-network-network/go-dogeum/trie"
...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale dogeum state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
				...
				Description: `
gdoge snapshot prune-state <state-root>
...
during the use of GDoge, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
gdoge snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gdoge snapshot check-dangling-storage <state-root> traverses the snap storage 
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gdoge snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gdoge snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gdoge snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gdoge dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gdoge dump', but uses the snapshots

...
import (
	...
	jsassets "github.com/dogeum-network-network/go-dogeum/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-dogeum.
func init() {
	var err error

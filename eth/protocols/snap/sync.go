...
import (
	...
	"github.com/dogeum-network-network/go-dogeum/p2p/msgrate"
...
// Syncer is an Dogeum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Dogeum state over the
// snap protocol.

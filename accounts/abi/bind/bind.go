...
// Package bind generates Dogeum contract Go bindings.
//
// Detailed usage document and tutorial available on the go-dogeum Wiki page:
// https://github.com/dogeum-network-network/go-dogeum/wiki/Native-DApps:-Go-bindings-to-Dogeum-contracts
package bind

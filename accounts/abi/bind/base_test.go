...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call dogeum.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call dogeum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call dogeum.CallMsg) ([]byte, error) {

...
// mapped from textual names used in the tests below to actual Dogeum private
...
// address retrieves the Dogeum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Dogeum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/dogeum-network-network/go-dogeum/issues/17593). Whilst this

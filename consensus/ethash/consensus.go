...
// rules of the stock Dogeum ethash engine.
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/dogeum-network-network/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/dogeum-network-network/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +

...
// all blocks' seal as valid, though they still have to conform to the Dogeum
// consensus rules.
...
// still have to conform to the Dogeum consensus rules.
...
// they still have to conform to the Dogeum consensus rules.

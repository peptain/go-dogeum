...
// https://github.com/dogeum-network-network/EIPs/blob/master/EIPS/eip-3675.md
//
...
// rules of the Dogeum consensus engine.
...
// verifyHeader checks whether a header conforms to the consensus rules of the
// stock Dogeum consensus engine. The difference between the beacon and classic is

...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Dogeum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Dogeum account at a particular block.
    type Account {
    ...
    # Transaction is an Dogeum transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Dogeum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Dogeum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Dogeum block by number or by hash. If neither is

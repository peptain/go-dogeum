...
// Package graphql provides a GraphQL interface to Dogeum node data.
package graphql
...
// Account represents an Dogeum account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Dogeum transaction.
...
// Block represents an Dogeum block.
...
type CallData struct {
	From                 *common.Address // The Dogeum address the call is from.
	To                   *common.Address // The Dogeum address the call is to.

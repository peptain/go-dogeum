...
# 1. install gdoge for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gdoge
# 5. create gdoge, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable DOGEUM_SOCKET
...
!define GROUPNAME "Dogeum"
!define APPNAME "GDoge"
!define DESCRIPTION "Official Go implementation of the Dogeum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gdoge is installed global

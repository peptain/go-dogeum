Name "gdoge ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/dogeum-network-network/go-dogeum/issues"
!define UPDATEURL "https://github.com/dogeum-network-network/go-dogeum/releases"
!define ABOUTURL "https://github.com/dogeum-network-network/go-dogeum#dogeum-go"
...
# Install gdoge binary
Section "GDoge" DOGE_IDX
  SetOutPath $INSTDIR
  file {{.GDoge}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gdoge.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gdoge.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "GDoge incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GDoge outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GDoge UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "GDoge incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gdoge.exe" "" "" "Dogeum" 30303 "" "" ""
  SimpleFC::AdvAddRule "GDoge outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gdoge.exe" "" "" "Dogeum" "" 30303 "" ""
  SimpleFC::AdvAddRule "GDoge UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gdoge.exe" "" "" "Dogeum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/dogeum-network-network/EIPs/issues/147)
  ${EnvVarUpdate} $0 "DOGEUM_SOCKET" "R" "HKLM" "\\.\pipe\gdoge.ipc"
  ${EnvVarUpdate} $0 "DOGEUM_SOCKET" "A" "HKLM" "\\.\pipe\gdoge.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${DOGE_IDX}
    SectionGetSize ${DOGE_IDX} $0

...
coverpkg="github.com/dogeum-network-network/go-dogeum/..."
...
function compile_fuzzer {
  # Inputs:
  # $1: The package to fuzz, within go-dogeum
  # $2: The name of the fuzzing function
  # $3: The name to give to the final fuzzing-binary

  path=$GOPATH/src/github.com/dogeum-network-network/go-dogeum/$1
  func=$2
  fuzzer=$3

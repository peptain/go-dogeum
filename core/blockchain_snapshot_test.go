...
// It can be used for testing that restart GDoge normally.
...
// It can be used for testing that restart GDoge after the crash.
...
// Tests a GDoge restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a GDoge was crashed and restarts with a broken snapshot. In this case the
...
// Tests a GDoge was crashed and restarts with a broken snapshot. In this case
...
// Tests a GDoge was running with snapshot enabled. Then restarts without
...
// Tests the GDoge was running with snapshot enabled and resetHead is applied.
...
// Tests the GDoge was running with a complete snapshot and then imports a few

...
// Package types contains data types related to Dogeum consensus.
package types
...
// Header represents a block header in the Dogeum blockchain.
type Header struct {
...
// Block represents an entire block in the Dogeum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Dogeum RLP block format.

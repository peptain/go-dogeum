...
// NewID calculates the Dogeum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Dogeum fork ID from an existing chain instance.

...
pruning. Remember don't start the GDoge without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gdoge snapshot prune-state --help" for more details.
`

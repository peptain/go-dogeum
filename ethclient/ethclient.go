...
// Package ethclient provides a client for the Dogeum RPC API.
package ethclient
...
// Client defines typed wrappers for the Dogeum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*dogeum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (dogeum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q dogeum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q dogeum.FilterQuery, ch chan<- types.Log) (dogeum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q dogeum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg dogeum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg dogeum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg dogeum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*dogeum.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg dogeum.CallMsg) (uint64, error) {
...
func toCallArg(msg dogeum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *dogeum.SyncProgress {
	if p == nil {
		return nil
	}
	return &dogeum.SyncProgress{

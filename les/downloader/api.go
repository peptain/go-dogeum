...
// Syncing provides information when this nodes starts synchronising with the Dogeum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  dogeum.SyncProgress `json:"status"`
}

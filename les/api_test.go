...
import (
	...
	ethdownloader "github.com/dogeum-network-network/go-dogeum/eth/downloader"
	...
	"github.com/dogeum-network-network/go-dogeum/p2p/simulations"
	"github.com/dogeum-network-network/go-dogeum/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	dogeum, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, dogeum, &config)
	if err != nil {
		return nil, err
	}
	return dogeum, nil

// Copyright 2019 The go-dogeum Authors
...
// Package les implements the Light Dogeum Subprotocol.
package les
...
import (
	...
	"github.com/dogeum-network-network/go-dogeum/common/mclock"
	"github.com/dogeum-network-network/go-dogeum/consensus"
	"github.com/dogeum-network-network/go-dogeum/core"
	"github.com/dogeum-network-network/go-dogeum/core/bloombits"
	...
	"github.com/dogeum-network-network/go-dogeum/internal/shutdowncheck"
	"github.com/dogeum-network-network/go-dogeum/les/downloader"
	"github.com/dogeum-network-network/go-dogeum/les/vflux"
	vfc "github.com/dogeum-network-network/go-dogeum/les/vflux/client"
	"github.com/dogeum-network-network/go-dogeum/light"
	...
	"github.com/dogeum-network-network/go-dogeum/p2p/enr"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightDogeum, error) {
...
func (s *LightDogeum) VfluxRequest(n *enode.Node, reqs vflux.Requests) vflux.Replies {
	if !s.udpEnabled {
		return nil
	}
...
func (s *LightDogeum) vfxVersion(n *enode.Node) uint {
	if n.Seq() == 0 {
		var err error
		if !s.udpEnabled {
			return 0
...
func (s *LightDogeum) prenegQuery(n *enode.Node) int {
	if s.vfxVersion(n) < 1 {
...
// APIs returns the collection of RPC services the dogeum package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightDogeum) APIs() []rpc.API {
...
func (s *LightDogeum) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightDogeum) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightDogeum) TxPool() *light.TxPool              { return s.txPool }
func (s *LightDogeum) Engine() consensus.Engine           { return s.engine }
func (s *LightDogeum) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightDogeum) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightDogeum) EventMux() *event.TypeMux           { return s.eventMux }
func (s *LightDogeum) Merger() *consensus.Merger          { return s.merger }

// Protocols returns all the currently configured network protocols to start.
func (s *LightDogeum) Protocols() []p2p.Protocol {
...
// light dogeum protocol implementation.
func (s *LightDogeum) Start() error {

...
import (
	...
	"github.com/dogeum-network-network/go-dogeum/accounts/abi/bind/backends"
	...
	"github.com/dogeum-network-network/go-dogeum/contracts/checkpointoracle/contract"
	"github.com/dogeum-network-network/go-dogeum/core"
	"github.com/dogeum-network-network/go-dogeum/core/forkid"
	...
	"github.com/dogeum-network-network/go-dogeum/les/checkpointoracle"
	"github.com/dogeum-network-network/go-dogeum/les/flowcontrol"
	vfs "github.com/dogeum-network-network/go-dogeum/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some doge to user1
		...
		case 1:
			...
			// bankUser transfers more doge to user1
		...
		case 2:
			...
			// bankUser transfer some doge to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)

...
// This test reproduces https://github.com/dogeum-network-network/go-dogeum/issues/17837 where the
...
// It is the reproducer for https://github.com/dogeum-network-network/go-dogeum/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-dogeum-test-ipc-%d-%d", os.Getpid(), rand.Int63())

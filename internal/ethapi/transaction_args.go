...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/dogeum-network-network/go-dogeum/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend) error {
	...
	// https://github.com/dogeum-network-network/go-dogeum/pull/23274 for more information.

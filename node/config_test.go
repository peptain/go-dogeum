...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdoge.ipc", false, filepath.Join(os.TempDir(), "gdoge.ipc")},
		{"data", "gdoge.ipc", false, "data/gdoge.ipc"},
		{"data", "./gdoge.ipc", false, "./gdoge.ipc"},
		{"data", "/gdoge.ipc", false, "/gdoge.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdoge.ipc", true, `\\.\pipe\gdoge.ipc`},
		{"data", "gdoge.ipc", true, `\\.\pipe\gdoge.ipc`},
		{"data", `\\.\pipe\gdoge.ipc`, true, `\\.\pipe\gdoge.ipc`},
	}
